...
var getParsedNftAccountsByOwner = function (_a) {
    var publicAddress = _a.publicAddress, _b = _a.connection, connection = _b === void 0 ? (0, utils_1.createConnectionConfig)() : _b, _c = _a.sanitize, sanitize = _c === void 0 ? true : _c, _d = _a.stringifyPubKeys, stringifyPubKeys = _d === void 0 ? true : _d, _e = _a.sort, sort = _e === void 0 ? true : _e, _f = _a.limit, limit = _f === void 0 ? 5000 : _f, _g = _a.metaAccountsRequestChunkSize, metaAccountsRequestChunkSize = _g === void 0 ? 99 : _g;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    metadataAcountsAddressPromises = _h.sent();
                    metadataAccounts = metadataAcountsAddressPromises
                        .filter(onlySuccessfullPromises)
                        .map(function (p) { return p.value; });
                    return [4 /*yield*/, Promise.allSettled((0, lodash_chunk_1.default)(metadataAccounts, metaAccountsRequestChunkSize).map(function (chunk) {
                            return connection.getMultipleAccountsInfo(chunk);
                        }))];
                case 3:
                    metaAccountsRawPromises = _h.sent();
